...
That is `src/Billing/EDI270.php:L167`. The switch is the condition of the ternary, so the identifier is chosen per request at build time rather than being stored anywhere.
