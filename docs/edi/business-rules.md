...
| [BR-I6](#br-i6-one-switch-decides-whether-eligibility-can-be-requested-and-which-payer-identifier-the-request-carries) | One switch decides whether eligibility can be requested and which payer identifier the request carries | I | VERIFIED | n/a |
