...
| S7 | None | The payer's acknowledgement is uploaded to the **history temporary directory**, then filed read-only into `documents/edi/history/f997` in the **history directory** |
