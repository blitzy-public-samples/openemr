...
| `x12_isa04` | `sql/database.sql:L10035` | Ten spaces | ISA04. Comment describes it as the user password. Returned as stored and emitted on every claim interchange. **Security-sensitive:** flagged in Appendix A of [defect-candidates.md](defect-candidates.md) | Live on claims only | `src/Billing/Claim.php:L695` |
