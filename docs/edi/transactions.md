...
| `x12_isa04` | `sql/database.sql:L10035` | Ten spaces | ISA04. Comment describes it as the user password. Returned as stored and emitted on every claim interchange | Live on claims only | `src/Billing/Claim.php:L695` |
...
- [defect-candidates.md](defect-candidates.md) registers the suspected defects named throughout, and is where any security-sensitive observation about this subsystem is flagged, in its own appendix.
